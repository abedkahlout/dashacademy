...
const columns = [
    ...
    useEffect(()=>
    {
        async function getParentRequests()
        {
            setLoading(true)
            try{
                const response = await fetch(`${process.env.REACT_APP_API}/api/privateSchool/parent/request`,{
                    headers:{
                        "Authorization":token
                    }
                })
    ...
    async function acceptRequest(id)
    {
        try{
            filterRequests(id)
            const response = await fetch(`${process.env.REACT_APP_API}/api/privateSchool/parent/request/accept/${id}`,{
                method:"PUT",
                headers:{
                    "Authorization":token,
                },
    ...
    async function rejectRequest(id)
    {
        try{
            filterRequests(id)
            const response = await fetch(`${process.env.REACT_APP_API}/api/privateSchool/parent/request/reject/${id}`,{
                method:"PUT",
                headers:{
                    "Authorization":token,
                },
